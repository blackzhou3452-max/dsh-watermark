      ...
      properties: {
        ...
        search: {
          ...
          enum: ['auto', 'all', 'bottom-right', 'bottom-left', 'top-right', 'top-left', 'bottom',
            'top', 'corners', 'none'],
          description: 'Where to look for the mark. Default "auto": the four corners for '
            + 'detection (that is where platform marks live, and searching the whole frame '
            + 'measurably damages real photos), the whole frame when a template says where the '
            + 'mark is. Pass "all" explicitly for a centred mark.',
        },
        rect: {
          type: 'array',
          items: { type: 'string' },
